  ...
  return (
    <article className="max-w-3xl mx-auto bg-white rounded-xl border border-neutral-200 shadow-card p-8 md:p-12 space-y-6">
      ...
      <section className="space-y-4 text-sm leading-relaxed text-neutral-600 thai">
        ...
        <h2 className="text-base font-bold text-neutral-800 pt-4">1. การยืนยันตัวตน</h2>
        <p>
        ...
        <h2 className="text-base font-bold text-neutral-800 pt-4">2. ระบบ Escrow</h2>
        <p>
        ...
        <h2 className="text-base font-bold text-neutral-800 pt-4">
        ...
        <p className="text-xs text-neutral-400 pt-6 border-t border-neutral-100">
          ...
          <strong className="text-violet-600">legal@peerahat.com</strong>
        </p>
      </section>
    </article>
  );
