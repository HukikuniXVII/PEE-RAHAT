    ...
    <>
      ...
      >
        ...
        <section className="space-y-4 text-sm leading-relaxed text-ink-soft thai">
          ...
          <p>
            ติวเตอร์ทุกคนต้องผ่านการยืนยันตัวตนโดยส่งบัตรประชาชน
            เซลฟี่คู่กับบัตร และใบแสดงผลการเรียน ก่อนเปิดบริการ ข้อมูลเหล่านี้
            จะถูกเก็บแบบเข้ารหัสและใช้เพื่อการยืนยันตัวตนเท่านั้น
          </p>
          <h2 className="text-base font-bold text-grape-deep pt-4">
            2. ระบบพักเงินตัวกลาง
          </h2>
          <p>
            การชำระเงินทุกรายการจะถูกพักไว้กับแพลตฟอร์ม
          ...
          <p>
            เพื่อรักษาความปลอดภัยของเงินที่พักไว้ ห้ามแลกเปลี่ยนช่องทางติดต่อ
