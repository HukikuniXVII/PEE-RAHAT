      ...
      >
        ...
        <section className="space-y-4 text-sm leading-relaxed text-ink-soft thai">
          ...
          <p>
            ...
            Meet อัตโนมัติเมื่อมีคลาสที่ชำระเงินแล้ว เมื่อเชื่อมต่อแล้ว ผู้ใช้ตกลง
            ให้ Pee Rahat ขอสิทธิ์ OAuth 3 รายการ ได้แก่{" "}
            <code className="text-xs">calendar.events</code>{" "}
            (สร้าง/ลบเฉพาะอีเวนต์ที่ Pee Rahat สร้างเองในปฏิทินหลักของผู้ใช้),{" "}
            <code className="text-xs">userinfo.email</code>{" "}
            (อ่านอีเมล Google ครั้งเดียวเพื่อแสดงสถานะการเชื่อมต่อ) และ{" "}
            <code className="text-xs">openid</code> (scope คู่ของอีเมล)
            ระบบไม่เข้าถึงอีเวนต์อื่น ปฏิทินอื่น Gmail Drive Contacts
            หรือข้อมูลอื่นใดในบัญชี Google ของผู้ใช้
            รายละเอียดเพิ่มเติมและการเพิกถอนอยู่ในนโยบายความเป็นส่วนตัว
          </p>
